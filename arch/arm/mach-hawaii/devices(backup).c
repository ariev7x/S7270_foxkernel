...
static struct thermal_sensor_config sensor_data[] = {
	{			/* TMON sensor */
		...
		.thermal_warning_lvl_2 = 120000,
		.thermal_fatal_lvl = 150000,
	...
	{			/* 32kHz crystal sensor */
		...
		.thermal_warning_lvl_2 = 126000,
		.thermal_fatal_lvl = 136000,
		.thermal_warning_action = THERM_ACTION_NOTIFY,
		.thermal_fatal_action = THERM_ACTION_NOTIFY_SHUTDOWN,
#ifdef CONFIG_MFD_BCM_PMU590XX
	...
	{			/* PA sensor */
		...
		.thermal_warning_lvl_2 = 127000,
		.thermal_fatal_lvl = 137000,
		.thermal_warning_action = THERM_ACTION_NOTIFY,
		.thermal_fatal_action = THERM_ACTION_NOTIFY_SHUTDOWN,
#ifdef CONFIG_MFD_BCM_PMU590XX
...
struct kona_freq_tbl kona_freq_tbl[] = {
	...
	FTBL_INIT(1200000, PI_OPP_SUPER_TURBO, TEMP_DONT_CARE),
};
